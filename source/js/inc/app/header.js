...
module.exports = function () {
	...
	$search_toggle.click(function (e) {
		...
		if (Foundation.utils.is_small_only() || Foundation.utils.is_medium_only() || Foundation.utils.is_large_only() || ($has_basket && Foundation.utils.is_xlarge_only())) {
	...
	var close_button_visibility = function () {
		$close_search.attr('aria-hidden', Foundation.utils.is_small_only() || Foundation.utils.is_medium_only() || Foundation.utils.is_large_only() || ($has_basket && Foundation.utils.is_xlarge_only()));
	};
	...
	var mobile_search_visibility = function () {
		$search_form.attr('aria-hidden', Foundation.utils.is_small_only() || Foundation.utils.is_medium_only() || Foundation.utils.is_large_only() || ($has_basket && Foundation.utils.is_xlarge_only()));
	};
