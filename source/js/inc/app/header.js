...
module.exports = function () {
	...
	var close_button_visibility = function () {
		$close_search.attr('aria-hidden', Foundation.utils.is_small_only() || Foundation.utils.is_medium_only());
	};
	...
	var mobile_search_visibility = function () {
		$search_form.attr('aria-hidden', Foundation.utils.is_small_only() || Foundation.utils.is_medium_only());
	};
